...
public class URLProcessor extends Thread {
	...
	public void run()
	{
		...
		else if(str.contains("cntv"))
			siteSolver = new CntvSolver(m_url, m_page_que, m_file_que);
		else if(str.contains("v.163.com"))
			siteSolver = new WangyiSolver(m_url, m_page_que, m_file_que);
		//note:新的网页分析器放到此处
		else
